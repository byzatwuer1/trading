...
class BinanceFuturesBot:
    ...
    def generate_signals(self, df: pd.DataFrame) -> dict:
        ...
        try:
            ...
            # Üç Beyaz Asker (Three White Soldiers) Formasyonu
            three_white_soldiers_signal = three_white_soldiers(df)
